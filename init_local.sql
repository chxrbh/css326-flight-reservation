...
INSERT INTO `airline` (`airline_id`, `airline_iata_code`, `name`, `country`, `support_email`, `support_phone`) VALUES
(1, 'SA', 'SkyAsia Airlines', 'Thailand', 'support@skyasia.com', '+6621112222'),
(2, 'PG', 'Pacific Green', 'Singapore', 'help@pacificgreen.sg', '+6565555555');
...
INSERT INTO `airline_admin` (`employee_id`, `first_name`, `last_name`, `hire_date`, `airline_id`, `account_id`) VALUES
...
INSERT INTO `airport` (`airport_id`, `airport_iata_code`, `name`, `city`, `country`, `timezone`) VALUES
(1, 'BKK', 'Suvarnabhumi Airport', 'Bangkok', 'Thailand', 'UTC+7'),
(2, 'SIN', 'Changi Airport', 'Singapore', 'Singapore', 'UTC+8'),
(3, 'HND', 'Haneda Airport', 'Tokyo', 'Japan', 'UTC+9');
...
INSERT INTO `flight_schedule` (`flight_id`, `flight_no`, `origin_airport_id`, `destination_airport_id`, `aircraft_type`, `duration`, `max_seat`, `status`, `airline_id`) VALUES
(1, 'SA101', 1, 2, 'Airbus A320', '02:30:00', 180, 'active', 1),
(2, 'SA102', 2, 1, 'Airbus A320', '02:20:00', 180, 'active', 1),
(3, 'PG330', 1, 3, 'Boeing 737', '05:50:00', 200, 'active', 2);
...
INSERT INTO `gate` (`gate_id`, `airport_id`, `gate_code`, `status`) VALUES
(1, 1, 'A1', 'active'),
(2, 1, 'A2', 'active'),
(3, 2, 'B5', 'active'),
(4, 3, 'C7', 'maintenance');
...
INSERT INTO `gate_assignment` (`assignment_id`, `gate_id`, `instance_id`, `occupy_start_utc`, `occupy_end_utc`) VALUES
(1, 1, 1, '2025-10-10 07:30:00', '2025-10-10 09:15:00'),
(2, 1, 2, '2025-10-11 07:30:00', '2025-10-11 09:20:00'),
(3, 2, 3, '2025-10-10 13:30:00', '2025-10-10 15:15:00'),
(4, 3, 4, '2025-10-10 04:30:00', '2025-10-10 06:15:00');
...
INSERT INTO `ticket` (`ticket_id`, `ticket_no`, `passenger_id`, `instance_id`, `seat`, `price_usd`, `booking_date`, `status`) VALUES
(1, 'SA101-001', 1, 1, '12A', 120.00, '2025-10-05', 'booked'),
(2, 'SA101-002', 1, 2, '14C', 125.00, '2025-10-06', 'booked'),
(3, 'SA102-001', 1, 3, '10B', 118.00, '2025-10-07', 'checked-In'),
(4, 'PG330-001', 1, 4, '22A', 350.00, '2025-10-08', 'cancelled');
...
--
ALTER TABLE `gate`
  MODIFY `gate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
